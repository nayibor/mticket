                            ...
                            <div class="row-fluid" id="DIV_2">
                                <div class="span4" id="DIV_3">
                                    <!--  <div id="DIV_4" class="dataTables_length">
                                     ...
                                     <option value="5" selected="selected" id="OPTION_7">
                                                      5
                                                  </option>             
                                    <option value="10" id="OPTION_7">
                                                      10
                                                  </option>
                                            ...
                                            if ($content->{'success'} == 1) {
                                                ...
                                                foreach ($content->{'events'} as $cnt) {
                                                    ...
                                                    <tr class="gradeA <?php echo ($i % 2 == 0) ? "even" : "odd" ?>" id="TR_38">
                                                        ...
                                                        <td class=" " id="TD_40">
                                                            <b><?php echo date("F j, g:i a", $cnt->{'eventStart'}); ?></b> to  <b><?php echo date("F j, g:i a", $cnt->{'eventEnd'}); ?></b>
                                                        </td>
                                                        <td class=" " id="TD_41">
                                                      ...
                                                      <!--  <td class=" " id="TD_42">
                                                        ...
                                                        -->
                                                        <td class=" " id="TD_43">
                                                            <a href="buy.php?id=<?php echo $cnt->{'id'}; ?>">Buy Ticket</a>&nbsp;&nbsp;&nbsp;<!--<a href="calendar.php?id=<?php //echo $cnt->{'id'};  ?>">Add To Calendar</a>-->
                                                            &nbsp;&nbsp;&nbsp;<a href="event.php?id=<?php echo $cnt->{'id'}; ?>">More</a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $i++;
