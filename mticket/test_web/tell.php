...
<head>
<title>mobiTicketz.com::Tell a Friend</title>
  ...
  <div id="container" class="clear">
    ...
    <div id="content">
      <?php
        ...
        ?>
        <form name="tellform" id="tellform" action="process/tell.php" method="post">
        <p>Tell A friend about <strong><?php echo $name; ?></strong></p>
         <p>Happening Live At <strong><?php echo $_GET['loc']; ?></strong></p>
	<p>From <strong><?php echo $_GET['start']; ?></strong> to <strong><?php echo $_GET['end']; ?></strong></p>
        <input type="hidden" name="eventId" id="eventId" value="<?php echo $id; ?>"/>
        <input type="hidden" name="eventName" id="eventName" value="<?php echo $name; ?>"/>
        <input type="hidden" name="loc" id="loc" value="<?php echo $_GET['loc']; ?>"/>
        <input type="hidden" name="start" id="start" value="<?php echo $_GET['start']; ?>"/>
        <input type="hidden" name="end" id="end" value="<?php echo $_GET['end']; ?>"/>

        <p>Email Address(Friend):</p>
            <p><input type="text" name="emailAddr" id="emailAddr" size="50"/></p>
            <p>From:</p>
            <p>
              <input type="text" name="from" id="from" size="50"/>
            </p>
            <p>
                <input type="hidden" name="eventId" id="eventId" value="<?php echo $id; ?>"/>
                <input type="hidden" name="eventName" id="eventName" value="<?php echo $name; ?>"/>
                <input type="submit" value="Send" class="more"/>
            </p>
        </form>
    </div>
  </div>
