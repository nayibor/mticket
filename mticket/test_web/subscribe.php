...
<head>
<title>mobiTicketz.com::Subscribe</title>
  ...
  <div id="container" class="clear">
    ...
    <div id="content">
      <?php
        ...
        ?>
        <form name="subform" id="subform" action="process/subscribe.php" method="post">
        <p>Subscribe to Events by <strong><?php echo $name; ?></strong></p>
        <p>Your email Address:</p>
            ...
            <p>
                ...
                <input type="submit" value="Subscribe" class="more"/>
            </p>
        </form>
    </div>
  </div>
  ...
  <div id="footer" class="clear">
    ...
    <section class="one_third first">
      <div class="newsletter">
       ...
       <form method="post" action="process/subscribe1.php">
          <fieldset>
            <legend>Subscribe:</legend>
            <label for="nl_email">Email:</label>
            <input type="text" name="emailAddr1" id="emailAddr1" value="">
...
$(document).ready(function () {
    $("#emailAddr1").defaultvalue("Enter Your Email Here");
});
</script>
</body>
</html>