...
<head>
<title>mobiTicketz.com-Organisers</title>
  ...
  <div id="container" class="clear">
   ...
   <?php
	  //require_once("../engine/functions.inc.php");
		  $url="http://mobiticketz.com/api/institutions";
		  //echo $url;
		  $c = curl_init();
		...
		<?php
          ...
          <li>
            <p class="name"><a href="organiser.php?id=<?php echo $cnt->{'id'}; ?>"><strong><?php echo $cnt->{'longname'}; ?></a></strong></p>
           <p><?php echo $cnt->{'description'}; ?></p>
		   <p><?php echo $cnt->{'address'}; ?></p>
		   <p><?php echo $cnt->{'email'}; ?></p>
          </li>
		  <?php
			 ...
			 <p><a href="organisers.php">View More organisers &raquo;</a></p>
			 <?php
		   }
		 }
		 ?>
