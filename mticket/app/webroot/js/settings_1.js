...
var settings={
    ...
    init_settings:function(){
        ...
        settings.settings_div.dialog('close');
    ...
    init_password:function(){
        ...
        settings.password_div.dialog('close');
    ...
    init:function(){
        ...
        $(".stn").live('click',function(e) {
            ...
            settings.settings_div.dialog('open')    
        ...
        $(".change_password").live('click',function(e) {
            ...
            settings.password_div.dialog('open')      
    ...
    save_password:function(){
        ...
        $.ajax({
            ...
            success:function(data) {
                if(data.status=="true")          
                {
                    alert("Password Changed.\n .\nPlease Log In With New Password Next Time");
                    $(".ui-dialog-content").dialog("close");
