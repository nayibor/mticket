    ...
    <div class='tableWrapper'>
        <div class='tableHeader' style="border: 0px !important;">
            ...
            <ul class='tableActions'>
                ...
                <li>
                    <select name="data[Batch][batch_status_tickets]" id="data[Batch][batch_status_tickets]" >
                        <option 
                        <?php if (isset($batch) && $batch['Batch']['batch_status_tickets'] == "4") { ?>
                                selected="selected"
                            <?php } ?>  value='4' >Disabled</option>
                        <option 
                        <?php if (isset($batch) && $batch['Batch']['batch_status_tickets'] == "1") { ?>
                                selected="selected"
                            <?php } ?>  value='1' >Enabled</option>
                        <option 
                        <?php if (isset($batch) && $batch['Batch']['batch_status_tickets'] == "2") { ?>
                                selected="selected"
                            <?php } ?> value='2' >In Progress</option>   <option 
                            <?php if (isset($batch) && $batch['Batch']['batch_status_tickets'] == "3") { ?>
                                selected="selected"
                            <?php } ?> value='3'  >Done</option>  
                    </select>
