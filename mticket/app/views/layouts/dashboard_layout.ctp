...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body class="hasInterface hasGradient hasSidebar">
        ...
        <input type="hidden" name="logout_url" id="logout_url" value="<?php echo $html->url(array('controller' => 'Dashboard', 'action' => 'logoutUser')); ?>" />
        <input type="hidden" name="change_password_url" id="change_password_url" value="<?php echo $html->url(array('controller' => 'User', 'action' => 'change_password')); ?>" />
        ...
        <div id="oaHeader">
            <div id="oaNavigationExtraTop">
                <ul> 
                    ...
                    <?php } ?>
                    <li class="infoUser"><a href="<?php echo $html->url(array('controller' => 'Admin', 'action' => 'change_password')); ?>" class="change_password" >Change Password</a></li>
        ...
        <div id="firstLevelContent">
            ...
            <div id="secondLevelContent">
                ...
                <div id="thirdLevelContent" style="min-height: 456px;">
                    ...
                    <div name="site_div" id="site_div"></div>  
                    <div name="password_div" id="password_div"></div>  
                    <div name="settings_div" id="settings_div"></div>
